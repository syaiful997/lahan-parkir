			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('tempat_parkir') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('tempat_parkir/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kode_tempat_parkir') ? 'is-invalid':'' ?>"
								 type="text" name="kode_tempat_parkir" />
							...
							<div class="form-group">
								<label for="kapasitas">Kapasitas Mobil*</label>
								<input class="form-control <?php echo form_error('kapasitas') ? 'is-invalid':'' ?>"
								 type="number" name="kapasitas_mobil" min="0" />
								<div class=	"invalid-feedback">
